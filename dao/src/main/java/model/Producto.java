...
public class Producto {
	...
	public String toString() {
		return "CODIGO PRODUCTO: " + this.codigoProducto + " NOMBRE: " + this.nombre + " GAMA: " + this.gama+ " DIMENSIONES: " 
				+ this.dimensiones+ " PROVEEDOR: " + this.proveedor + " DESCRIPCION: " + this.descripcion+ " CANTIDAD DE STOCK: " + this.cantidadStock
