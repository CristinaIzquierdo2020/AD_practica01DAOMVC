...
public class Cliente {
	...
	public String toString() {
		return  "CODIGO CLIENTE: " + this.codigoCliente + ", " + "NOMBRE CLIENTE: " +this.nombreCliente + ", " +  "NOMBRE CONTACTO: "+ this.nombreContacto + ", " + "APELLIDO CONTACTO: "+ this.apellidoContacto + ", " + "TELEFONO: " + this.telefono + ", " + "FAX: " + this.fax + ", " + "DIRECCION1: " + this.lineaDireccion1 + ", " + "DIRECCION2: " + this.lineaDireccion2 + ", " + "CIUDAD: " + this.ciudad + ", " + "REGION: " + this.region + ", " + "PAIS: " + this.pais + ", " + "CODIGO POSTAL: " + this.codigoPostal + ", " + "REP_VENTAS: " + this.codigoEmpleadoRepVentas + ", " + "LIMITE CREDITO: " + this.limiteCredito;
	}
}
